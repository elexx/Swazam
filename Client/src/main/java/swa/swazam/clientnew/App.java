...
import swa.swazam.clientnew.uis.CommandLineUI;
import swa.swazam.clientnew.uis.GraphicUI;
import swa.swazam.clientnew.uis.TestsuiteUI;
...
public class App {
	...
	private static Properties loadConfig(String configPath) throws IOException {
		...
		if (configPath != null) {
			...
			configFile.load(App.class.getClassLoader().getResourceAsStream("client.properties"));
		}
		return configFile;
	}
