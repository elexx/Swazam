...
*) Please copy your peer mp3 files to Swazam/Testsuite/data/<PeerX> 
where PeerX is the folder that contains the music database for peer X.

*) Please copy the mp3 snippets for the client's search to Swazam/Testsuite/data/Client
...
*) The TestSuite holds after executing all automatic tests. 
